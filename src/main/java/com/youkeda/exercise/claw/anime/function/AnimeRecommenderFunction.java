...
public class AnimeRecommenderFunction implements LLMFunction {

    private static final Logger log = LoggerFactory.getLogger(AnimeRecommenderFunction.class);
    ...
    public AnimeRecommenderFunction(AniListClient aniListClient,
    ...
    public void init() {
        ...
        log.info("AnimeRecommenderFunction 已注册");
    }
    ...
    public String execute(String argumentsJson, FunctionExecutionContext context) {
        try {
            ...
            log.error("AnimeRecommenderFunction 执行失败", e);
