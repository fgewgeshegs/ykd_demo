 ...
 */
@Component
public class FileListFunction implements LLMFunction {

    private static final Logger log = LoggerFactory.getLogger(FileListFunction.class);

    private final FileService fileService;
    private final LLMFunctionRegistry functionRegistry;
    private final ObjectMapper objectMapper;

    public FileListFunction(FileService fileService,
    ...
    public void init() {
        ...
        log.info("FileListFunction 已注册到 LLMFunctionRegistry");
    }
