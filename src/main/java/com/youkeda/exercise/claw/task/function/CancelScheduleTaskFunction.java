package com.youkeda.exercise.claw.task.function;
 ...
 */
@Component
public class CancelScheduleTaskFunction implements LLMFunction {

    private static final Logger log = LoggerFactory.getLogger(CancelScheduleTaskFunction.class);

    private final ObjectMapper objectMapper;
    private final LLMFunctionRegistry functionRegistry;
    private final ScheduledTaskRepository taskRepository;

    public CancelScheduleTaskFunction(ObjectMapper objectMapper,
    ...
    public void init() {
        ...
        log.info("CancelScheduleTaskFunction 已注册到 LLMFunctionRegistry");
    }
